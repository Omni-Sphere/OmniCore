...
DELETE FROM "CustomButtons" WHERE "MessageCode" IN ('TPL_WELCOME_WITH_RESERVATION', 'TPL_WELCOME_PROMPT', 'TPL_RESERVATION_DETAILS', 'TPL_NOT_FOUND_ERROR', 'TPL_CARD_PAYMENT_SUCCESS', 'TPL_CARD_PAYMENT_FAILED', 'TPL_BANK_TRANSFER_INFO', 'TPL_SPEI_PAYMENT_RECEIVED', 'TPL_PAYMENT_REJECTED', 'TPL_TRANSFER_REJECTED');
